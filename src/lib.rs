// src/lib.rs
/*
 * Core library for EmailMarketing
 */
...
#[derive(Debug)]
pub struct EmailMarketingProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EmailMarketingProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EmailMarketing processing");
    
    let mut processor = EmailMarketingProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EmailMarketingProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EmailMarketingProcessor::new(false);
